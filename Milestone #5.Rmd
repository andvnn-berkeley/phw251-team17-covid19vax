...
Our final clean dataset needed to undergo mean imputation before our new 
variables are created, which was performed next. 
...
The Table, "Vaccination Rates for Caliornia Counties," displays the partial vaccinated rate, fully vaccinated rate, 
total eligible population, and median age of each county in California. 
